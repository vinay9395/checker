...
$botToken = "7151132209:AAHtyWZowttk_8bhfCPMUSlQ3vH19qZDH6E";
...
$emojid = '❌';
$emojil = '✅';
$owner = '<code>@frsegs</code>';
$botu = "𝘽𝙊𝙏 𝙐𝙋𝘿𝘼𝙏𝙀𝙎 ↯ @nethercheats";
$bota = "<b>|×| 𝘿𝙀𝙑 ↯ @frsegs</b>";$eror = "<b>Error ❌</b>";
...
$keyboard = json_encode([
    'inline_keyboard' => [
        [
            ['text' => "↯ 𝘽𝙐𝙔 𝘼𝘾𝘾𝙀𝙎𝙎", 'url' => "https://t.me/frsegs"],
        ],
    ]
]);
